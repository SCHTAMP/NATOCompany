...
force force ace_overheating_unJamFailChance = 0.287319;
...
force force grad_trenches_functions_bigEnvelopeDigTime = 600;
...
force force grad_trenches_functions_giantEnvelopeDigTime = 900;
force force grad_trenches_functions_LongEnvelopeDigTime = 15;
force force grad_trenches_functions_shortEnvelopeDigTime = 15;
force force grad_trenches_functions_smallEnvelopeDigTime = 5;
