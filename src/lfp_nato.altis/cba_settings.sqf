...
force ace_overheating_unJamFailChance = 0.287319;
...
Achilles_var_Hawaiians_75th_Rangers = true;
...
Achilles_var_mas_can_amulti = true;
Achilles_var_mas_can_caor1 = true;
Achilles_var_mas_can_daor2 = true;
Achilles_var_mas_can_ewint = true;
Achilles_var_mas_can_gspec = true;
Achilles_var_mas_can_idiver = true;
Achilles_var_mas_can_jparas = true;
Achilles_var_mas_can_kswat = true;
Achilles_var_mas_can_lnav = true;
